...
static inline void VALVE1_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTD_set_pin_pull_mode(4, pull_mode);
}
static inline void VALVE1_set_dir(const enum port_dir dir)
{
	PORTD_set_pin_dir(4, dir);
}
static inline void VALVE1_set_isc(const PORT_ISC_t isc)
{
	PORTD_pin_set_isc(4, isc);
}
static inline void VALVE1_set_inverted(const bool inverted)
{
	PORTD_pin_set_inverted(4, inverted);
}
static inline void VALVE1_set_level(const bool level)
{
	PORTD_set_pin_level(4, level);
}
static inline void VALVE1_toggle_level()
{
	PORTD_toggle_pin_level(4);
}
static inline bool VALVE1_get_level()
{
...
static inline void VALVE2_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTA_set_pin_pull_mode(0, pull_mode);
}
static inline void VALVE2_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(0, dir);
}
static inline void VALVE2_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(0, isc);
}
static inline void VALVE2_set_inverted(const bool inverted)
{
	PORTA_pin_set_inverted(0, inverted);
}
static inline void VALVE2_set_level(const bool level)
{
	PORTA_set_pin_level(0, level);
}
static inline void VALVE2_toggle_level()
{
	PORTA_toggle_pin_level(0);
}
static inline bool VALVE2_get_level()
{
...
static inline void VALVE3_set_pull_mode(const enum port_pull_mode pull_mode)
{
	PORTC_set_pin_pull_mode(3, pull_mode);
}
static inline void VALVE3_set_dir(const enum port_dir dir)
{
	PORTC_set_pin_dir(3, dir);
}
static inline void VALVE3_set_isc(const PORT_ISC_t isc)
{
	PORTC_pin_set_isc(3, isc);
}
static inline void VALVE3_set_inverted(const bool inverted)
{
	PORTC_pin_set_inverted(3, inverted);
}
static inline void VALVE3_set_level(const bool level)
{
	PORTC_set_pin_level(3, level);
}
static inline void VALVE3_toggle_level()
{
	PORTC_toggle_pin_level(3);
}
static inline bool VALVE3_get_level()
{
